...
public class ConfirmDialogPresenter<V extends ConfirmDialogMvpView> extends BasePresenter<V>
        implements ConfirmDialogMvpPresenter<V> {

    public static final String TAG = "ConfirmDialogPresenter";

    @Inject
    public ConfirmDialogPresenter(DataManager dataManager,
    ...
    public void onNegativeClicked() {
        getMvpView().negativeActionTaken();
    }

    @Override
    public void onPositiveClicked() {
        getMvpView().positiveActionTaken();
    }
