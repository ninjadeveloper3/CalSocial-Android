...
public class AttendeesAddGuestAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    public static final int VIEW_TYPE = 0;
    private AttendeesAdapter.Callback mCallback;
    private List<EventAttendeesResponse.User> mUserResponseList;
    private Context context;
    private Random rand;


    public AttendeesAddGuestAdapter(List<EventAttendeesResponse.User> userResponseList, Context context) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AttendeeAddGuestViewHolder(
