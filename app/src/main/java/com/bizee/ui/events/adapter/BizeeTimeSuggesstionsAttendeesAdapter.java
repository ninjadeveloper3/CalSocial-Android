...
public class CalSocialTimeSuggesstionsAttendeesAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public CalSocialTimeSuggesstionsAttendeesAdapter(List<EventAttendeesResponse.User> userResponseList, Context context) {
        mUserResponseList = userResponseList;
        this.context = context;
        rand = new Random();
    }

    public void setCallback(CalSocialTimeSuggesstionsAttendeesAdapter.Callback callback) {
        mCallback = callback;
    }
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CalSocialTimeSuggestionsAttendeeViewHolder(
