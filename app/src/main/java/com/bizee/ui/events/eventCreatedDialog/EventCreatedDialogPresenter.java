...
public class EventCreatedDialogPresenter<V extends EventCreatedDialogMvpView> extends BasePresenter<V>
        implements EventCreatedDialogMvpPresenter<V> {
    ...
    @Inject
    public EventCreatedDialogPresenter(DataManager dataManager,
