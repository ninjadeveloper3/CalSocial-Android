...
public class ContactsCalSocialNetworkAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public ContactsCalSocialNetworkAdapter(List<ContactsHiveResponse.User> userList, Context context) {
        mUsersResponseList = userList;
        this.context = context;
    }

    public void setCallback(ContactsCalSocialNetworkAdapter.Callback callback) {
        mCallback = callback;
    }
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ContactsCalSocialNetworkViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.contacts_item_CalSocial_network_add_to_hive_layout, parent, false), mUsersResponseList, context);
