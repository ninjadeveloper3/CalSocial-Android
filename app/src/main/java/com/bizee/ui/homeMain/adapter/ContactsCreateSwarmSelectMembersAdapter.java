...
public class ContactsCreateSwarmSelectMembersAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public ContactsCreateSwarmSelectMembersAdapter(List<ContactsHiveResponse.User> userList, Context context) {
        mUsersResponseList = userList;
        this.context = context;
    }

    public void setCallback(ContactsCreateSwarmSelectMembersAdapter.Callback callback) {
        mCallback = callback;
    }
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ContactsCreateSwarmSelectMembersViewHolder(
