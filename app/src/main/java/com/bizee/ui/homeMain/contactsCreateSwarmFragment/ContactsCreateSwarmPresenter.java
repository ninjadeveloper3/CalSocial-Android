...
public class ContactsCreateSwarmPresenter<V extends ContactsCreateSwarmMvpView> extends BasePresenter<V> implements ContactsCreateSwarmMvpPresenter<V> {

    @Inject
    public ContactsCreateSwarmPresenter(DataManager dataManager,
