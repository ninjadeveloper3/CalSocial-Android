...
public class MessagesDetailPresenter<V extends MessagesDetailsMvpView> extends BasePresenter<V> implements MessagesDetailMvpPresenter<V> {

    @Inject
    public MessagesDetailPresenter(DataManager dataManager,
