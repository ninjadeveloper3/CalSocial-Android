...
public class EditSwarmMembersAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public EditSwarmMembersAdapter(List<UsersResponse.User> userList, Context context) {
        mUsersResponseList = userList;
        this.context = context;
        rand = new Random();
    }

    public void setCallback(EditSwarmMembersAdapter.Callback callback) {
        mCallback = callback;
    }
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new EditSwarmMembersViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.profiles_item_swarm_edit_profile_members_item_layout, parent, false), mUsersResponseList, context);
    }
