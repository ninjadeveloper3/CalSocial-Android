...
public class HiveMembersAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public HiveMembersAdapter(List<UsersResponse.User> userList, Context context) {
        mUsersResponseList = userList;
        this.context = context;
        rand = new Random();
    }

    public void setCallback(HiveMembersAdapter.Callback callback) {
        mCallback = callback;
    }
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new HiveMembersViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.profiles_item_view_hive_members_item_layout, parent, false), mUsersResponseList);
