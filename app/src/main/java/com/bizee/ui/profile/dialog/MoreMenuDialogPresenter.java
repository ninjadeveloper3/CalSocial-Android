...
public class MoreMenuDialogPresenter<V extends MoreMenuDialogMvpView> extends BasePresenter<V>
        implements MoreMenuDialogMvpPresenter<V> {
    ...
    @Inject
    public MoreMenuDialogPresenter(DataManager dataManager,
